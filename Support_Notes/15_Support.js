...
// delete = Delete(using index),Pop, shift 1
...
// let strnames=[ 'Siddhant', 'AmOl', 'vaibhav', 'shree', 'arjun', 'amal' ]
...
//   return el.startsWith("a");//  in array the string conatins a then sort it out
// });

// console.log(filterA);

// varname.map((el,index,arr)=>{
//   // condition 
// })
...
// // Foreach
// let strnames1=[ 'Siddhant', 'AmOl', 'vaibhav', 'shree', 'arjun', 'amal' ]
// let snames1 = strnames1.forEach((el, index, arr) => {
// console.log ([el.toLowerCase()])

// });// ans will not in array , it does not having return type, ity will console in barckets
