...
let dice1 = Math.floor(Math.random() * 6) + 1; // gives 1–6
let dice2 = Math.floor(Math.random() * 6) + 1; // gives 1–6
...
//is code uses Math.random() to get a number between 0–1, multiplies it by 10, floors it, and adds 5 to produce a random integer from 5 to 14.
