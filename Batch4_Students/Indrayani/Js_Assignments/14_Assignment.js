...
for (let match of matches) {
  total_income += parseInt(match)
}
console.log("Total annual income is: " + total_income + " euro") 
...
let str = "first_name"
let str2 = "first-name"
let str3 = "1first_name"
let str4 = "firstname"
let validvar = /^[a-zA-Z_$][a-zA-Z0-9_$]*$/

console.log(validvar.test(str)) 
console.log(validvar.test(str2)) 
console.log(validvar.test(str3)) 
console.log(validvar.test(str4)) 
