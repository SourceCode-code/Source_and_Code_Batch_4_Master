...
let age = 25
let goal = "To became perfect in JavaScript"
console.log("Name:", name)
console.log("Age:", age)
console.log("Goal for Diwali learning:", goal)

// Q2. Declare 3 variables in one line and print them.
let firstName = "Swapnil", lastName = "Gaikwad", country = "India"
...
let passOrFail = undefined
console.log(typeof passOrFail)

let agreeOrNot = null
console.log(typeof agreeOrNot)
...
//Explanation  : It returns number.


console.log((parseInt("Sangamner")))
