...
// In the following shopping cart add, remove, edit items:
 ...
 shoppingCart.splice(1,0,"Peanuts")  // added 1 item in the shopping cart
console.log(shoppingCart)

shoppingCart.splice(0,1)           // removes an item from whichever position we want
console.log(shoppingCart)

// add 'Meat' in the beginning of your shopping cart if it has not been already added
shoppingCart.splice(0,1,"Maeat")
console.log(shoppingCart)
...
let newAge = ages.sort((a,b) => {
    return (a-b)
})
console.log(newAge)
console.log(Math.max(...newAge))
console.log(Math.min(...newAge))
